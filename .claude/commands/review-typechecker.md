...
- [ ] Every new happy-path behavior has at least one passing typechecking test (a `.mtl` fixture under `tests/integration/sources/typechecking/`, or a unit test under `tests/unit/`)
